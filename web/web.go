...
func (web *Web) newHandler() http.Handler {
	...
	router.HandleFunc("/displays/field_audience", web.fieldAudienceDisplayHandler).Methods("GET")
	router.HandleFunc("/displays/field_audience/websocket", web.fieldAudienceDisplayWebsocketHandler).Methods("GET")
