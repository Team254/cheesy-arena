...
func TestTeamSign_GenerateInMatchRearText(t *testing.T) {
	...
	assert.Equal(t, "01:23 R103-B229 88/100", generateInMatchTeamRearText(arena, true, "01:23"))
	assert.Equal(t, "01:23 B229-R103 114/360", generateInMatchTeamRearText(arena, false, "01:23"))

	// Check that RP progress is hidden for playoff matches.
	arena.CurrentMatch.Type = model.Playoff
	assert.Equal(t, "00:45 R103-B229 ", generateInMatchTeamRearText(arena, true, "00:45"))
	assert.Equal(t, "00:45 B229-R103 ", generateInMatchTeamRearText(arena, false, "00:45"))
