...
const overlayCenteringBottomHideParams = {queue: false, bottom: "-300px"};
const overlayCenteringBottomShowParams = {queue: false, bottom: "475px"};
...
$(function() {
  ...
  websocket = new CheesyWebsocket("/displays/field_audience/websocket", {
