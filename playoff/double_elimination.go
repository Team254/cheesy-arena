...
// scheduled breaks. Only supports having exactly four to eight alliances.
func newDoubleEliminationBracket(numAlliances int) (*Matchup, []breakSpec, error) {
	switch numAlliances {
	case 4:
		return newFourAllianceDoubleEliminationBracket()
	case 5:
		return newFiveAllianceDoubleEliminationBracket()
	case 6:
		return newSixAllianceDoubleEliminationBracket()
	case 7:
		return newSevenAllianceDoubleEliminationBracket()
	case 8:
		return newEightAllianceDoubleEliminationBracket()
	default:
		return nil, nil, fmt.Errorf("double-elimination bracket must have exactly 4 to 8 alliances")
	}
}
...
func newFourAllianceDoubleEliminationBracket() (*Matchup, []breakSpec, error) {
	...
	m3 := Matchup{
		...
		matchSpecs:         newDoubleEliminationMatch(3, "Round 2 Upper", 540),
	}
	m4 := Matchup{
		id:                 "M4",
		NumWinsToAdvance:   1,
		...
		matchSpecs:         newDoubleEliminationMatch(4, "Round 2 Lower", 540),
	}
	...
	m5 := Matchup{
		...
		matchSpecs:         newDoubleEliminationMatch(5, "Round 3 Lower", 300),
	}
...
// Creates a five-alliance double-elimination bracket.
func newFiveAllianceDoubleEliminationBracket() (*Matchup, []breakSpec, error) {
	// Define Round 1 matches.
	m1 := Matchup{
		id:                 "M1",
		NumWinsToAdvance:   1,
	...
	m7 := Matchup{
		...
		matchSpecs:         newDoubleEliminationMatch(7, "Round 2 Upper", 300),
	}
...
// Creates a six-alliance double-elimination bracket.
func newSixAllianceDoubleEliminationBracket() (*Matchup, []breakSpec, error) {
	// Define Round 1 matches.
	m1 := Matchup{
		id:                 "M1",
		NumWinsToAdvance:   1,
	...
	m9 := Matchup{
		...
		matchSpecs:         newDoubleEliminationMatch(9, "Round 3 Lower", 300),
	}
...
// Creates an seven-alliance double-elimination bracket.
func newSevenAllianceDoubleEliminationBracket() (*Matchup, []breakSpec, error) {
	// Define Round 1 matches.
	m1 := Matchup{
		id:                 "M1",
		NumWinsToAdvance:   1,
	...
	m6 := Matchup{
		...
		NumWinsToAdvance:   1,
		redAllianceSource:  matchupSource{matchup: &m2, useWinner: false},
		blueAllianceSource: matchupSource{matchup: &m3, useWinner: false},
		matchSpecs:         newDoubleEliminationMatch(6, "Round 2 Lower", 540),
	}
	m7 := Matchup{
		id:                 "M7",
	...
	m10 := Matchup{
		id:                 "M10",
		NumWinsToAdvance:   1,
		redAllianceSource:  matchupSource{matchup: &m8, useWinner: true},
		blueAllianceSource: matchupSource{matchup: &m7, useWinner: true},
	...
	m11 := Matchup{
		id:                 "M11",
		NumWinsToAdvance:   1,
		redAllianceSource:  matchupSource{matchup: &m9, useWinner: false},
		blueAllianceSource: matchupSource{matchup: &m10, useWinner: true},
		matchSpecs:         newDoubleEliminationMatch(11, "Round 4 Upper", 300),
	}
	...
	final := Matchup{
		id:                 "F",
		NumWinsToAdvance:   2,
		redAllianceSource:  matchupSource{matchup: &m9, useWinner: true},
		blueAllianceSource: matchupSource{matchup: &m11, useWinner: true},
		matchSpecs:         newFinalMatches(14),
	}
...
// Creates an eight-alliance double-elimination bracket.
func newEightAllianceDoubleEliminationBracket() (*Matchup, []breakSpec, error) {
	// Define Round 1 matches.
	m1 := Matchup{
		id:                 "M1",
		NumWinsToAdvance:   1,
