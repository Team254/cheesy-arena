...
type EventSettings struct {
	...
	CapacityWhenControlPanelDisabled int
}
...
func (database *Database) GetEventSettings() (*EventSettings, error) {
	...
	eventSettings := EventSettings{
		...
		ControlPanelDisabled:             game.ControlPanelDisabled,
		CapacityWhenControlPanelDisabled: game.CapacityWhenControlPanelDisabled,
	}
