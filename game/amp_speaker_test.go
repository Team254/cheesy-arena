...
func TestAmpSpeaker_MatchSequence(t *testing.T) {
	...
	ampSpeaker.UpdateState(0, 0, false, false, matchStartTime, timeAfterStart(0), false)
	assertAmpSpeaker(0, 0, 0, 0, 0)

	// Score in the Amp and Speaker during auto.
	ampSpeaker.UpdateState(1, 0, false, false, matchStartTime, timeAfterStart(1), false)
	...
	ampSpeaker.UpdateState(2, 0, false, false, matchStartTime, timeAfterStart(2), false)
	assertAmpSpeaker(2, 0, 0, 0, 0)
	assert.Equal(t, 2, ampSpeaker.BankedAmpNotes)
	ampSpeaker.UpdateState(2, 3, false, false, matchStartTime, timeAfterStart(3), false)
	assertAmpSpeaker(2, 0, 3, 0, 0)
	ampSpeaker.UpdateState(3, 4, false, false, matchStartTime, timeAfterStart(4), false)
	assertAmpSpeaker(3, 0, 4, 0, 0)
	assert.Equal(t, 2, ampSpeaker.BankedAmpNotes)

	// Pressing the buttons during auto should not have any effect.
	ampSpeaker.UpdateState(3, 4, true, true, matchStartTime, timeAfterStart(5), false)
	assert.Equal(t, 2, ampSpeaker.BankedAmpNotes)
	...
	ampSpeaker.UpdateState(4, 6, false, false, matchStartTime, timeAfterStart(17.9), false)
	assertAmpSpeaker(4, 0, 6, 0, 0)
	ampSpeaker.UpdateState(5, 8, false, false, matchStartTime, timeAfterStart(18.1), false)
	assertAmpSpeaker(4, 1, 6, 2, 0)
	assert.Equal(t, 2, ampSpeaker.BankedAmpNotes)

	// Activate co-op.
	ampSpeaker.UpdateState(5, 8, false, true, matchStartTime, timeAfterStart(20), false)
	assertAmpSpeaker(4, 1, 6, 2, 0)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	assert.Equal(t, true, ampSpeaker.CoopActivated)

	// Activate co-op a second time.
	ampSpeaker.UpdateState(5, 8, false, false, matchStartTime, timeAfterStart(21), false)
	assertAmpSpeaker(4, 1, 6, 2, 0)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	assert.Equal(t, true, ampSpeaker.CoopActivated)

	// Try to activate amplify with insufficient notes banked.
	ampSpeaker.UpdateState(5, 8, true, false, matchStartTime, timeAfterStart(22), false)
	assertAmpSpeaker(4, 1, 6, 2, 0)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	assert.Equal(t, false, ampSpeaker.isAmplified(timeAfterStart(22), false))

	// Score more notes in the Amp and amplify.
	ampSpeaker.UpdateState(7, 8, false, false, matchStartTime, timeAfterStart(23), false)
	assertAmpSpeaker(4, 3, 6, 2, 0)
	assert.Equal(t, 2, ampSpeaker.BankedAmpNotes)
	ampSpeaker.UpdateState(7, 8, true, false, matchStartTime, timeAfterStart(24), false)
	assertAmpSpeaker(4, 3, 6, 2, 0)
	...
	ampSpeaker.UpdateState(8, 11, false, false, matchStartTime, timeAfterStart(25), false)
	...
	ampSpeaker.UpdateState(8, 15, false, false, matchStartTime, timeAfterStart(27), false)
	...
	ampSpeaker.UpdateState(10, 15, true, false, matchStartTime, timeAfterStart(30), false)
	...
	ampSpeaker.UpdateState(10, 16, true, false, matchStartTime, timeAfterStart(32), false)
	assertAmpSpeaker(4, 6, 6, 5, 5)
	ampSpeaker.UpdateState(10, 17, true, false, matchStartTime, timeAfterStart(42.9), false)
	...
	ampSpeaker.UpdateState(10, 18, true, false, matchStartTime, timeAfterStart(43.1), false)
	...
	ampSpeaker.UpdateState(11, 21, false, false, matchStartTime, timeAfterStart(152.9), false)
	assertAmpSpeaker(4, 7, 6, 9, 6)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	ampSpeaker.UpdateState(13, 23, true, false, matchStartTime, timeAfterStart(153.1), false)
	assertAmpSpeaker(4, 7, 6, 11, 6)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	ampSpeaker.UpdateState(13, 24, true, false, matchStartTime, timeAfterStart(157.9), false)
	assertAmpSpeaker(4, 7, 6, 12, 6)
	ampSpeaker.UpdateState(13, 25, false, false, matchStartTime, timeAfterStart(158.1), false)
	assertAmpSpeaker(4, 7, 6, 12, 6)
	...
	ampSpeaker.UpdateState(0, 0, false, true, matchStartTime, timeAfterStart(20), false)
	assert.Equal(t, false, ampSpeaker.CoopActivated)

	// Attempt to co-op in a playoff match.
	ampSpeaker.UpdateState(1, 0, false, true, matchStartTime, timeAfterStart(20), true)
	assert.Equal(t, false, ampSpeaker.CoopActivated)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	...
	ampSpeaker.UpdateState(1, 0, false, true, matchStartTime, timeAfterStart(62.9), false)
	...
	ampSpeaker.UpdateState(1, 0, false, true, matchStartTime, timeAfterStart(63.1), false)
	assertAmpSpeaker(0, 1, 0, 0, 0)
	assert.Equal(t, 1, ampSpeaker.BankedAmpNotes)
	assert.Equal(t, false, ampSpeaker.CoopActivated)
	...
	ampSpeaker.UpdateState(2, 0, false, true, matchStartTime, timeAfterStart(60), false)
	...
	ampSpeaker.UpdateState(2, 0, true, false, matchStartTime, timeAfterStart(70), false)
	assertAmpSpeaker(0, 2, 0, 0, 0)
	ampSpeaker.UpdateState(2, 1, true, false, matchStartTime, timeAfterStart(71), false)
	...
	ampSpeaker.UpdateState(2, 4, false, false, matchStartTime, timeAfterStart(72), false)
	...
	ampSpeaker.UpdateState(4, 4, true, false, matchStartTime, timeAfterStart(73), false)
	...
	ampSpeaker.UpdateState(100, 44, false, false, matchStartTime, timeAfterStart(94), false)
	...
	ampSpeaker.UpdateState(101, 57, false, false, matchStartTime, timeAfterStart(98.9), false)
	...
	ampSpeaker.UpdateState(102, 60, false, false, matchStartTime, timeAfterStart(99.1), false)
	...
	ampSpeaker.UpdateState(102, 60, true, false, matchStartTime, timeAfterStart(152), false)
	ampSpeaker.UpdateState(102, 63, true, false, matchStartTime, timeAfterStart(157), false)
	...
	ampSpeaker.UpdateState(102, 66, true, false, matchStartTime, timeAfterStart(157.9), false)
